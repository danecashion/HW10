...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LED.setMinimumSize(QtCore.QSize(150, 150))
        self.LED.setObjectName("LED")
        self.gridLayout.addWidget(self.LED, 0, 0, 1, 1)
        self.indicator = QtWidgets.QRadioButton(self.centralwidget)
        ...
        self.indicator.setAutoExclusive(False)
        self.indicator.setObjectName("indicator")
        self.gridLayout.addWidget(self.indicator, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LED.setText(_translate("MainWindow", "LED"))
        self.indicator.setText(_translate("MainWindow", "INDICATOR"))
